...
<c:url var="linkActualizar" value="/cliente/muestraFormularioActualizar"><!-- nos lleva a la url a modificar -->
<c:param name="clienteId" value="${clienteTemp.id }"/> <!-- el parámetro que le pasamos a la url -->
</c:url>

<!-- link para eliminar -->
<c:url var="linkEliminar" value="/cliente/eliminar"><!-- nos lleva a la url a eliminar -->
<c:param name="clienteId" value="${clienteTemp.id }"/> <!-- el parámetro que le pasamos a la url -->
</c:url>
